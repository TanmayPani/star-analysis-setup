...
//Modifiers
    ...
    static void addTriggerToMap(std::string trig, unsigned int* ids, int size);
    static void clearTriggerMap(){_triggerMap.clear();}
    #ifndef __CINT__
    static std::map<std::string, std::vector<unsigned int>> triggerMap(){return _triggerMap;}
    static void setTriggerMap(std::map<std::string, std::vector<unsigned int>> trigMap){_triggerMap = trigMap;}
    #endif
